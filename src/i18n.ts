...
export const t = {
  es: {
    ...
    comments: { title: 'Anotaciones', placeholder: 'Añade una corrección o comentario...', submit: 'Enviar', empty: 'Sin anotaciones aún.' },
    auth: { login: 'Login', register: 'Registro', email: 'Email', password: 'Password (min 6 chars)', enter: 'Entrar', createAccount: 'Crear cuenta', install: 'Instalar', installDesc: 'Instala Todo-OSINT en tu dispositivo', installSub: 'Acceso instantáneo, funciona offline, sin app store', delete: 'Eliminar' },
  ...
  en: {
    ...
    comments: { title: 'Annotations', placeholder: 'Add a correction or comment...', submit: 'Send', empty: 'No annotations yet.' },
    auth: { login: 'Login', register: 'Register', email: 'Email', password: 'Password (min 6 chars)', enter: 'Sign In', createAccount: 'Create Account', install: 'Install', installDesc: 'Install Todo-OSINT on your device', installSub: 'Instant access, works offline, no app store', delete: 'Delete' },
